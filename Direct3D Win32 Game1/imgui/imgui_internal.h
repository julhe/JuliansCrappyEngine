...
namespace ImGui
{
    ...
    IMGUI_API void          Release(ImGuiContext* context);    // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().
